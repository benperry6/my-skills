...
This skill was imported from a Codex-era workflow. In Hermes, use it as a candidate evaluator doctrine for substantial acceptance decisions, not as a mandatory gate just because it exists. Prefer direct behavioral verification first, then decide whether this skill adds useful structure or only ceremony.
