...
This skill was imported from a Codex-era workflow. In Hermes, do not treat the existence of this skill as proof that its harness is the optimal solution. Start from the underlying failure mode, prefer the simplest Hermes-native mechanism that works, and record whether this skill was load-bearing or merely ceremony.
