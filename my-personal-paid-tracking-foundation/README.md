...
- les secrets et blobs de bootstrap rematerialisables vont dans 1Password (vault `Agent Operations`), referencables via `op read "op://Agent Operations/<item>/<field>"`
