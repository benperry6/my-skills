...
3. ask the other engine(s) to read the transcripts, inspect the code, and compare implementation vs intent
4. surface findings, completeness verdict, behavior-confidence verdict, and test recommendations
